...
/**
 * This is an event sourced entity. It has a state, {@link ShipooState}, which
 ...
 */
public class ShipooEntity extends PersistentEntity<ShipooCommand, ShipooEvent, ShipooState> {
   ...
   */
  @Override
  public Behavior initialBehavior(Optional<ShipooState> snapshotState) {
    ...
    BehaviorBuilder b = newBehaviorBuilder(
        snapshotState.orElse(new ShipooState("Hello", LocalDateTime.now().toString())));
    ...
    b.setEventHandler(GreetingMessageChanged.class,
        ...
        // the event.
        evt -> new ShipooState(evt.message, LocalDateTime.now().toString()));
